...
function Footer() {
  return (
    ...
    <div className='w-full bg-gray-800 lg:p-8 mt-8 flex justify-between '>
      <div className='flex flex-col w-1/3 '>
          <strong className='text-yellow-200 text-2xl mb-2 text-center'>درباره ما</strong>
      ...
      <div className='w-1/4  flex flex-col items-center'>
        <strong className='text-yellow-200 text-2xl mb-2 text-center'>تماس با ما</strong>
